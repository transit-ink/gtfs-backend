...
export class CalendarController {
  ...
  @ApiResponse({ status: 200, description: 'Returns all calendars', type: [Calendar] })
  ...
  @ApiResponse({ status: 200, description: 'Returns the calendar', type: Calendar })
  ...
  @ApiResponse({ status: 201, description: 'Calendar created successfully', type: Calendar })
  ...
  @ApiResponse({ status: 200, description: 'Calendar updated successfully', type: Calendar })
  @ApiResponse({ status: 404, description: 'Calendar not found' })
  update(
    @Param('id') id: string,
